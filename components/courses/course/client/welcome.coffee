FlowRouter.route '/course/:course_slug/welcome', 
    name: 'course_welcome'
    action: (params) ->
...
Template.course_welcome.helpers
    course: -> Courses.findOne slug: FlowRouter.getParam('course_slug')
...
#         @current_doc = Courses.findOne slug: FlowRouter.getParam('course_slug')
#         self = @
#         {
