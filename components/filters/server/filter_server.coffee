Meteor.publish 'location_tags', (selected_theme_tags, selected_author_ids=[], selected_location_tags, selected_intention_tags)->
...
Meteor.publish 'intention_tags', (selected_theme_tags, selected_author_ids=[], selected_location_tags, selected_intention_tags)->
